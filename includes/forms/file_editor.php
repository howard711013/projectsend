                                                ...
                                                <div class="tab-pane fade show active" id="content-basic-<?php echo $i; ?>" role="tabpanel">
                                                    <div class="file_data">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea id="description_<?php echo $file->id; ?>" name="file[<?php echo $i; ?>][description]" class="<?php if ( get_option('files_descriptions_use_ckeditor') == 1 ) { echo 'ckeditor'; } ?> form-control textarea_description" placeholder="<?php _e('Optionally, enter here a description for the file.', 'cftp_admin');?>"><?php if (!empty($file->description)) { echo (get_option('files_descriptions_use_ckeditor') == 1) ? htmlentities_allowed($file->description) : html_output(description_for_edit($file->description)); } ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
